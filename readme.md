...
4. Seggment the training data to training-validation, put the validation images in data_validation folder
5. Run retrain inception.py, this will export a pb file or a keras model based on Inception-v3 architecture in inception folder
